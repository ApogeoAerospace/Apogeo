        ...
        this.charts.altitude = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: ' Altitude Profile and Vertical Velocity'
                    }
                },
                scales: {
                    x: {
        ...
        this.charts.atmosphere = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: ' Atmospheric Properties - ISA Model Implementation'
                    },
                    legend: {
                        display: true,
                        position: 'top'
        ...
        this.charts.gravity = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: ' Gravity Field - Varies with Altitude (g = GM/r²)'
                    },
                    legend: {
                        display: true,
                        position: 'top'
                ...
                scales: {
                    ...
                    y: {
                        title: { display: true, text: ' Gravity (m/s²)' },
                        suggestedMin: -12,
                        suggestedMax: 0
                    }
                }
