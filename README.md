...
Este proyecto utiliza un modelo de desarrollo basado en ramas:

- **main**: Esta rama contiene el código listo para producción. Todo el desarrollo debe realizarse en otras ramas.
